...
compile:
	g++ $(SRC) $(INCLUDE) $(LIBS) -std=c++20 -O3 -o app

run:
	./app

compile-test-ecs:
	g++ $(SRC_NOENT) Test/ECS.cpp -Itest $(INCLUDE) $(LIBS)  -std=c++20 -O3 -o test

compile-test-scene:
	g++ $(SRC_NOENT) Test/Scene.cpp $(INCLUDE) $(LIBS) -Itest -std=c++20 -O3 -o test

compile-test-vector2:
	g++ $(SRC_NOENT) Test/Vector2.cpp $(INCLUDE) $(LIBS) -Itest -std=c++20 -O3 -o test

compile-test-angle:
	g++ $(SRC_NOENT) Test/Angle.cpp $(INCLUDE) $(LIBS) -Itest -std=c++20 -O3 -o test

compile-test-physics:
	g++ $(SRC_NOENT) Test/Physics.cpp $(INCLUDE) $(LIBS) -Itest -std=c++20 -O3 -o test

compile-test-sprite:
	g++ $(SRC_NOENT) Test/Sprite.cpp $(INCLUDE) $(LIBS) -Itest -std=c++20 -O3 -o test
